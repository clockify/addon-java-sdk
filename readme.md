...
## TODO
- Implement and return an API client for clockify
- Update validations once documentation is ready
- Populate HttpRequest fields containing authentication & product info
- Add builtin middlewares for verifying JWT etc
